...
import com.plcoding.cryptotracker.crypto.data.networking.dto.CoinsHistoryResponseDto
...
// Implementation of "crypto/domain/CoinDataSource"
class RemoteCoinDataSource(
    private val httpClient: HttpClient
) : CoinDataSource {

    // API for list of coins
    ...
    // API for history of prices of a selected coin
